...
export default function TimelineChartJa({ assignments, months }: TimelineChartProps) {
                  ...
                  {hoveredBar === bar.projectId && assignment && (
                    <div className="absolute z-20 bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-64 p-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg">
                      ...
                      <div className="space-y-1 text-xs text-gray-600 dark:text-gray-400">
                        <div>
                          <span className="font-medium">期間:</span> {formatDate(assignment.startDate)} - {formatDate(assignment.endDate)}
                        </div>
                        <div>
                          <span className="font-medium">割り当て:</span> {assignment.allocation}%の時間
                        </div>
                        <div>
                        ...
                        <div>
                          <span className="font-medium">役割:</span> {assignment.project.role}
                        </div>
                        {assignment.project.technologies.length > 0 && (
                          <div>
                            <span className="font-medium">技術:</span>
